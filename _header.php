...
echo '<nav class="navbar navbar-expand-lg navbar-dark bg-dark  fixed-top navbar-expand-md-2  py-0 sticky position:sticky">


<div class="container-fluid">
<a href="index.html" class="navbar-brand">
   
  <a class="navbar-brand" href="/aanchaljaiswal"><h1 class="text-uppercase text-primary mb-1" >SuperCars</h1></a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <a href="_logout.php" role="button" class="btn btn-outline-success ml-2">Logout</a></form>';
    }
    else{
